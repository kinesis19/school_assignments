...
int main(){
	...
	printf("%d %s\n", s1.stu_num, s1.stu_name);
	
	//
	printf("%d %s %d %d %d %d %.1f %c\n", s1.stu_num, s1.stu_name, s1.kor, s1.eng, s1.math, s1.sum, s1.avg, s1.rating);
	printf("%d %s %d %d %d %d %.1f %c\n", s2.stu_num, s2.stu_name, s2.kor, s2.eng, s2.math, s2.sum, s2.avg, s2.rating);
	printf("%d %s %d %d %d %d %.1f %c\n", s3.stu_num, s3.stu_name, s3.kor, s3.eng, s3.math, s3.sum, s3.avg, s3.rating);
	printf("%d %s %d %d %d %d %.1f %c\n", s4.stu_num, s4.stu_name, s4.kor, s4.eng, s4.math, s4.sum, s4.avg, s4.rating);
	printf("%d %s %d %d %d %d %.1f %c\n", s5.stu_num, s5.stu_name, s5.kor, s5.eng, s5.math, s5.sum, s5.avg, s5.rating);
